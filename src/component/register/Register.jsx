...
const Register = () => {
  const {createUser,passError,setPassError,setSuccess}=useContext(AuthContext);
...
const handleRegister=(e)=>{
  ...
  setPassError('');
  console.log(name,photoURL,terms,'name and photo');
...
<div className="hero bg-slate-300 ">
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      ...
      <p className="py-6">
      <p>If registration has been completed, please log in now.  <Link to="/login"><span  className="font-bold text-green-900">login</span></Link> </p>
      </p>
    </div>
    ...
    <form onSubmit={handleRegister} className="card-body">
        ...
        <div className="form-control">
          ...
          <label className="label">
       <p> <input type="checkbox" name="terms" /> <span>Please check our terms</span> </p>
         </label>
