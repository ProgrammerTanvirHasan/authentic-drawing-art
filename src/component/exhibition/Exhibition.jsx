    ...
    <div className="lg:grid grid-cols-2 lg:py-24 px-4 text-white card bg-stone-900 shadow gap-8">
      ...
      <div className="grid-cols-1 pr-8 ">
        <p className="text-white ">
          Pixart Exhibits is a contemporary exhibition space where art and
          technology converge to showcase extraordinary artworks. Here, you can
          experience a variety of innovative art forms, including digital art,
          interactive installations, and VR experiences. Pixart Exhibits serves
          as a fantastic destination for art enthusiasts to discover new facets
          of creativity.
        </p>
